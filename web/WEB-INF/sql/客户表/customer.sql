...
CREATE TABLE `cm_customer` (
  ...
  `cm_customer` int(11) NOT NULL DEFAULT '0' COMMENT '默认为0  ， 1是删除',
...
-- Records of customer
-- ----------------------------
INSERT INTO `cm_customer` VALUES ('1', '常州嬉戏谷有限公司', '常州嬉戏谷有限公司', '9132041258558635XF', '招商银行', '0123000103000008865', '051088550001', '常州市武进区雪堰镇太北路1号', '夏楠', '13806182806', 'mia@demeter7.com', '常州市武进区雪堰镇太北路1号', '夏楠', '13806182806', 'mia@demeter7.com', '常州市武进区雪堰镇太北路1号', '夏楠', '13806182806', 'mia@demeter7.com', null, '花生', null, '张浩一', '没有', '2018-06-13 00:08:26', null, '0');
INSERT INTO `cm_customer` VALUES ('2', '埃梯梯精密机械制造（无锡）有限公司', '埃梯梯精密机械制造（无锡）有限公司', '91320214789913869F', '中国银行', '0123000103000008835', '051088550000', '无锡新区梅村锡达路570号', '张三', '13806182805', 'vincent.zhang@itt.com', '无锡新区梅村锡达路570号', 'Vincent Zhang', '13806182805', 'vincent.zhang@itt.com', '无锡新区梅村锡达路570号', 'Vincent Zhang', '13806182805', 'vincent.zhang@itt.com', null, '杨凯', null, '杨磊', '不要用公司胶带', '2018-06-20 00:08:21', null, '0');
