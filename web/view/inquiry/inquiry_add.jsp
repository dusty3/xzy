...
<form action="<%=basePath%>addinquiry"  name="addinquiry" method="post" class="form-horizontal">
   	<div class="row">
    ...
    <table style="border-collapse:separate; border-spacing:10px 10px;">
        <tr>
            ...
            <td><input type="text" name="inquiryId" value="${newinquiryid}" placeholder="请输入询价单号（不用输入，自动生成）" readonly="readonly"/></td>
            <td><label >询价日期</label></td>
            <td><input type="date" name="inquiryCreatetime"  value="${createdate}" placeholder="请输入询价日期（不用输入，自动生成系统时间）" readonly="readonly"/></td>
            <td><label >询价方式</label></td>
            <td><select id="activename1" readonly="readonly" name="inquiryStyle">
                <option value="0" >邮件</option>
                <option value="1" >人工询价</option>
            </select></td>
        ...
        <tr>
            ...
            <td><input type="text"  required="required" id="customerName" name="customerName"  placeholder="请输入客户名称" autocomplete="off" /></td>
            <div id="search_cutomer" name="search_cutomer" ></div>
            <td><label >客户联系人</label></td>
            <td><input type="text" id="customerLinkman" name="customerLinkman"  placeholder="客户联系人"  readonly="readonly"/></td>
            <td><label >供应商编号</label></td>
            <td><input type="text" id="supplierId" name="supplierId"  placeholder="供应商编号" readonly="readonly"/></td>
            <td><label >业务员</label></td>
            <td><input type="text" name="inquiryMakingpartname"  value="${sessionScope.user.loginUsercode}" placeholder="请输入业务员（默认登录用户，不可修改）" readonly="readonly"/></td>
        </tr>
        <tr>
            ...
            <td><label >业务员备注</label></td>
            <td><input type="text" name="inquiryMark"  placeholder="请输入业务员备注" /></td>
        </tr>
        <tr>
            <td><label >供应商名称</label></td>
            <td><input type="text" required="required" id="supplierName" name="supplierName" autocomplete="off"  placeholder="请输入供应商名称" /></td>
            <div id="search_supplier" name="search_supplier" ></div>

            <td><label >供应商联系人</label></td>
            <td><input type="text" id="supplierInquiryman" name="supplierInquiryman"  placeholder="" readonly="readonly"/></td>
            <td><label >供应商邮箱</label></td>
            <td><input type="text"  id="supplierInquiryemail" name="supplierInquiryemail"  placeholder="" readonly="readonly"/></td>
            <td><label >供应商特点</label></td>
            <td><input type="text"  id="supplierDescription" name="supplierDescription"  placeholder="" readonly="readonly"/></td>
        </tr>
    </table>
